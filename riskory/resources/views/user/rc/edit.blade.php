                ...
                <form id="msform" role="form" method="POST" action="{{route('rc.update',$rc)}}" class="create-risk-form risk-form px-lg-5">
                    ...
                    @method('PUT')
                        <fieldset id="firstfieldset">
                            ...
                            <input type="text" name="title" value="{{$rc->title}}" class="form-control p-5 br-20 box-shadow border-0 font-16 font-e color-dg @error('title') is-invalid @enderror" placeholder="Enter The Risk Control Title" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="obj" value="{{$rc->objective}}" class="form-control p-5 br-20 box-shadow border-0 font-16 font-e color-dg @error('obj') is-invalid @enderror" placeholder="Enter The Risk Control Objective" required>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="desc" id="desc" cols="30" rows="3" class="form-control p-5 br-20 box-shadow border-0 font-16 font-e color-dg @error('desc') is-invalid @enderror" placeholder="Enter The Risk Control Description" required>{{$rc->description}}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="frequency" value="{{$rc->frequency}}" id="frequency" class="form-control p-5 br-20 box-shadow border-0 font-16 font-e color-dg @error('frequency') is-invalid @enderror" min="0" placeholder="Enter The Risk Control Frequency">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="px-5 pb-2 pt-4 br-20 box-shadow border-0 font-16 font-e bg-white" id="testingSteps">
                                    ...
                                    @if($rc->testingsteps)
                                        ...
                                        <div class="steps row border-gray-1 my-3 " id="step{{$tscount}}">
                                            <input type="text" value="{{$ts->step}}" name="testing_steps[]" class="form-control border-0 font-16 font-e color-dg col-10 col-sm-11" placeholder="Some Testing Steps" required>
                            ...
                            <input type="text" name="business_impact" value="{{$rc->business_impact}}" class="form-control p-5 br-20 box-shadow border-0 font-16 font-e color-dg" placeholder="Enter The Risk Control Business Impact">
                            ...
                            <input type="text" name="recommendation" value="{{$rc->recommendation}}" class="form-control p-5 br-20 box-shadow border-0 font-16 font-e color-dg" placeholder="Enter The Risk Control Corrective Action Recommendations">
                                <small id="recommendations" class="form-text text-muted ml-3">
                            ...
                            <div class="mb-4 text-right">
                                ...
                                <button class="btn-create mr-4 mr-sm-0 mt-3 mt-sm-0">Update</button>
                            </div>
                        </fieldset>
...
<script type="text/javascript">
    ...
    var arrOfIds = <?php echo json_encode($relationIds);?>;
