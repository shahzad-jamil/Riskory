...
<div class="px-0 col-12 col-md-9 py-2">
    <div class="row pt-4 mx-0">
        <div class="pl-0 col-12 col-sm-12 col-md-6 col-lg-9">
            <div class="">
            <p class="bg-lblue font-eb font-18 py-2 px-5"><i><img src="{{asset('assets/images/Mask Group 10@2x.png')}}" class="align-bottom" width="35px"></i>&nbsp;&nbsp;All Risk Controls</p>
            </div>
        </div>
    ...
    <div class="jumbotron jumbotron">
        <div class="container">
          ...
          <p class="lead">No data posted in this category....</p>
        </div>
      </div>
    @endif
