...
<div class="row 
    ...
    <div class="col-9 col-md-9 text-left text-md-left float-md-left d-flex align-items-center">
        ...
        <div class="d-inline-block pt-1 pl-2">
            ...
            <p class="p-style mb-0 font-eb font-18"><a href="#" class="color-b">{{$ls->name}} </a> <small><a href="javascript:void(0)" data-id="{{$ls->id}}" title="Delete list" data-toggle="modal" id="delListBtn" onclick="assignIdOfList({{$ls->id}})" data-target="#deleteModal">Delete</a></small></p>
    ...
    <div class="col-3 col-md-3 text-center text-md-right mt-1 mt-md-0 float-md-right">
        <div class="d-inline-block mx-3 mt-2">
            @if($ls->type==0)
            <a href="#" class="font-eb color-lg font-24" title="Private"><i class="fas fa-lock"></i></a>
            @elseif($ls->type==1)
            <a href="#" class="font-eb color-lg font-24" title="Public"><i class="fas fa-lock-open"></i></a>
            @endif
        </div>
    </div>
</div>
