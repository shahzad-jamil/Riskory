            ...
            @csrf
                ...
                <div class="form-row">
                    <div class="col">
                      ...
                      <input type="date" class="form-control" placeholder="Date of Birth" id="dob" name="dob" value="{{$user->dob}}">
                    </div>
                    <div class="col">
                ...
                <button type="submit" class="float-right btn btn-outline-secondary">Update</button>
              </form>
